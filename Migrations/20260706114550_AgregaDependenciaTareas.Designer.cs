...
namespace NotebookValidator.Web.Migrations
{
    ...
    [Migration("20260706114550_AgregaDependenciaTareas")]
    partial class AgregaDependenciaTareas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotebookValidator.Web.Data.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("HorasSemanalesContratadas")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.Cliente", b =>
                {
                    ...
                    b.Property<TimeSpan>("HoraSalidaNormal")
                        .HasColumnType("time");

                    b.Property<TimeSpan>("HoraSalidaViernes")
                        .HasColumnType("time");
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.ComentarioProyecto", b =>
                {
                    ...
                    b.Property<int?>("SubFaseProyectoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubFaseProyectoId");

                    b.ToTable("ComentariosProyecto");
                });

            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.ComentarioTarea", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.Feriado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.SubFaseProyecto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FaseProyectoId");

                    b.HasIndex("ResponsableId");

                    b.ToTable("SubFasesProyecto");
                });
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.TareaProyecto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("HorasRealesDeducidas")
                        .HasColumnType("decimal(5,2)");
                    ...
                    b.ToTable("TareasProyecto");
                });

            modelBuilder.Entity("NotebookValidator.Web.Models.NotificacionProyecto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.ComentarioProyecto", b =>
                {
                    ...
                    b.HasOne("NotebookValidator.Web.Models.GestorProyectos.SubFaseProyecto", "SubFase")
                        .WithMany("Comentarios")
                        .HasForeignKey("SubFaseProyectoId");

                    b.Navigation("Proyecto");

                    b.Navigation("SubFase");
                });

            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.ComentarioTarea", b =>
                {
                    b.HasOne("NotebookValidator.Web.Models.GestorProyectos.TareaProyecto", "Tarea")
                        .WithMany()
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.SubFaseProyecto", b =>
                {
                    b.HasOne("NotebookValidator.Web.Models.GestorProyectos.FaseProyecto", "Fase")
                        .WithMany("SubFases")
                        .HasForeignKey("FaseProyectoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NotebookValidator.Web.Data.ApplicationUser", "Responsable")
                        .WithMany()
            ...
            modelBuilder.Entity("NotebookValidator.Web.Models.GestorProyectos.TareaProyecto", b =>
                {
                    ...
                    b.HasOne("NotebookValidator.Web.Models.GestorProyectos.TareaProyecto", "TareaPredecesora")
                        .WithMany()
                        .HasForeignKey("TareaPredecesoraId");

                    b.HasOne("NotebookValidator.Web.Data.ApplicationUser", "UsuarioAsignado")
                        .WithMany()
